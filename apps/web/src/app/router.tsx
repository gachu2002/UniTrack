...
function TeacherAdminLayout() {
  ...
  if (currentUser.data.role !== 'teacher' && currentUser.data.role !== 'admin') {
    return <ForbiddenState eyebrow="Workspace folders" title="Folders are restricted" message="Only teachers and admins can manage project folders." />
  }
  return <Outlet />
}
...
function AdminLayout() {
  ...
  if (currentUser.data.role !== 'admin') {
    return <ForbiddenState eyebrow="Admin area" title="Admin is restricted" message="Only admins can manage accounts." />
  }
  return <Outlet />
}
