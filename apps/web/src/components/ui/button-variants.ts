...
export const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 rounded-lg text-sm font-semibold whitespace-nowrap transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/25 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground shadow-sm shadow-cyan-950/10 hover:bg-primary/90',
        secondary: 'border border-secondary/20 bg-secondary/10 text-secondary hover:bg-secondary/15 hover:border-secondary/30',
        ...
        outline: 'border border-border bg-card/90 text-ink hover:border-primary/30 hover:bg-accent',
