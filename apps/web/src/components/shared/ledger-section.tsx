...
export function LedgerSection({ title, eyebrow, description, action, children, className, bodyClassName, id }: LedgerSectionProps) {
  return (
    <section id={id} className={cn('overflow-hidden rounded-[1.4rem] bg-card/90 shadow-[0_14px_36px_rgba(7,89,133,0.08)] ring-1 ring-sky-900/10 backdrop-blur', className)}>
